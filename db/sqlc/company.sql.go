...
func (q *Queries) CreateAirline(ctx context.Context, arg CreateAirlineParams) (Airline, error) {
	row := q.queryRow(ctx, q.createAirlineStmt, createAirline, arg.CompanyName, arg.IataCode, arg.RegistaredCountry)
	var i Airline
	err := row.Scan(
		&i.ID,
		&i.CompanyName,
...
func (q *Queries) DeleteAirline(ctx context.Context, id int64) error {
	_, err := q.exec(ctx, q.deleteAirlineStmt, deleteAirline, id)
	return err
}
...
func (q *Queries) GetAirline(ctx context.Context, id int64) (Airline, error) {
	row := q.queryRow(ctx, q.getAirlineStmt, getAirline, id)
	var i Airline
	err := row.Scan(
		&i.ID,
		&i.CompanyName,
...
func (q *Queries) ListAirline(ctx context.Context, arg ListAirlineParams) ([]Airline, error) {
	rows, err := q.query(ctx, q.listAirlineStmt, listAirline, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
