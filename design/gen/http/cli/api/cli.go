...
import (
	...
	bookingc "github.com/niiniyare/awo/design/gen/http/booking/client"
	flightc "github.com/niiniyare/awo/design/gen/http/flight/client"
...
func UsageExamples() string {
	return os.Args[0] + ` flight search --body '{
