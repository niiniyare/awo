...
var FlightSearchRequestPrams = Type("FlightSearchRequestPrams", func() {
	Attribute("origin", String, "Origin airport code", func() {
		MinLength(3)
		MaxLength(3)
	})
	Attribute("destination", String, "Destination airport code", func() {
		MinLength(3)
		MaxLength(3)
	})
	Attribute("departure_date", String, "Departure date and time")
	Attribute("return_date", String, "Return date and time (for round trip searches)")
	Attribute("one_way", Boolean, "True for one-way searches, false for round trip searches")
	Required("origin", "destination", "departure_date", "one_way")
})

var FlightSearchResponse = ResultType("FlightResult", func() {
	Attribute("id", Int, "Unique Flight Booking Identifier")
	Attribute("origin", String, "Origin Airport Code")
	Attribute("destination", String, "Destination Airport Code")
	Attribute("departure_date", String, "Departure Date (YYYY-MM-DD)")
...
var BookingFlightPrams = Type("booking_flight_prams", func() {
	Attribute("origin", String, "Origin airport code", func() {
		MinLength(3)
		MaxLength(3)
	})
