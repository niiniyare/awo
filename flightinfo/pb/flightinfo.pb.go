...
func (x *StreamingResponse) Reset() {
	*x = StreamingResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_flightinfo_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*StreamingResponse) Descriptor() ([]byte, []int) {
	return file_proto_flightinfo_proto_rawDescGZIP(), []int{4}
}
...
func (x *Ping) Reset() {
	*x = Ping{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_flightinfo_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Ping) Descriptor() ([]byte, []int) {
	return file_proto_flightinfo_proto_rawDescGZIP(), []int{5}
}
...
func (x *Pong) Reset() {
	*x = Pong{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_flightinfo_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Pong) Descriptor() ([]byte, []int) {
	return file_proto_flightinfo_proto_rawDescGZIP(), []int{6}
}
...
var file_proto_flightinfo_proto_rawDesc = []byte{
	...
	0x69, 0x6e, 0x66, 0x6f, 0x22, 0x1b, 0x0a, 0x07, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12,
	...
	,
	...
	0x2e, 0x66, 0x6c, 0x69, 0x67, 0x68, 0x74, 0x69, 0x6e, 0x66, 0x6f, 0x2e, 0x50, 0x69, 0x6e, 0x67,
	0x1a, 0x10, 0x2e, 0x66, 0x6c, 0x69, 0x67, 0x68, 0x74, 0x69, 0x6e, 0x66, 0x6f, 0x2e, 0x50, 0x6f,
	0x6e, 0x67, 0x22, 0x00, 0x28, 0x01, 0x30, 0x01, 0x42, 0x0f, 0x5a, 0x0d, 0x2e, 0x2f, 0x3b, 0x66,
...
var file_proto_flightinfo_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_proto_flightinfo_proto_goTypes = []interface{}{
	(*Message)(nil),           // 0: flightinfo.Message
	(*Request)(nil),           // 1: flightinfo.Request
	(*Response)(nil),          // 2: flightinfo.Response
	(*StreamingRequest)(nil),  // 3: flightinfo.StreamingRequest
	(*StreamingResponse)(nil), // 4: flightinfo.StreamingResponse
	(*Ping)(nil),              // 5: flightinfo.Ping
	(*Pong)(nil),              // 6: flightinfo.Pong
}
var file_proto_flightinfo_proto_depIdxs = []int32{
	1, // 0: flightinfo.Flightinfo.Call:input_type -> flightinfo.Request
	3, // 1: flightinfo.Flightinfo.Stream:input_type -> flightinfo.StreamingRequest
	5, // 2: flightinfo.Flightinfo.PingPong:input_type -> flightinfo.Ping
	2, // 3: flightinfo.Flightinfo.Call:output_type -> flightinfo.Response
	4, // 4: flightinfo.Flightinfo.Stream:output_type -> flightinfo.StreamingResponse
	6, // 5: flightinfo.Flightinfo.PingPong:output_type -> flightinfo.Pong
...
func file_proto_flightinfo_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_flightinfo_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_flightinfo_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Ping); i {
			case 0:
				return &v.state
			case 1:
		...
		file_proto_flightinfo_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Pong); i {
			case 0:
				return &v.state
			case 1:
