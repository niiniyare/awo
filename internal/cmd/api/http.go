...
import (
	...
	bookingsvr "github.com/niiniyare/awo/internal/gen/http/booking/server"
	flightsvr "github.com/niiniyare/awo/internal/gen/http/flight/server"
...
func handleHTTPServer(ctx context.Context, u *url.URL, flightEndpoints *flight.Endpoints, bookingEndpoints *booking.Endpoints, wg *sync.WaitGroup, errc chan error, logger *log.Logger, debug bool) {
